...
var render = function render() {
  ...
  return _c("main", {
    ...
    staticClass: "btn btn-light shadow-sm text-primary font-weight-bold rounded-pill px-4",
    on: {
      click: function click($event) {
...
var staticRenderFns = [function () {
  ...
  return _c("div", [_c("h4", {
    ...
    staticClass: "fas fa-calendar-check text-primary mr-2"
  }), _vm._v(" Mis Consultas")]), _vm._v(" "), _c("small", {
    staticClass: "text-muted"
  }, [_vm._v("Gestión de tus citas médicas y pacientes")])]);
}, function () {
  var _vm = this,
    _c = _vm._self._c;
  return _c("span", {

...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    faltasCitas: function faltasCitas() {
      ...
      return this.paciente.appointments.filter(function (cita) {
        return _this.getStatusName(cita.status) === 'Cancelado' || cita.status == 3 || cita.status == 5;
      });
    },
    reprogramacionesCitas: function reprogramacionesCitas() {
      ...
      if (!this.paciente.appointments) return [];
      return this.paciente.appointments.filter(function (cita) {
        return _this2.getStatusName(cita.status) === 'Reprogramado' || cita.status == 4;
      });
    },
    ...
    documentosFiltrados: function documentosFiltrados() {
      ...
      return this.paciente.archivos_list.filter(function (d) {
        return d.tipo === _this3.filtroDocumento;
      });
    }
  },
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _this4.savingPlanSeguridad = true;
              payload = _objectSpread({
                patient_id: _this4.paciente.id
              }, _this4.nuevoPlanSeguridad);
              _context.next = 5;
              return axios.post('/api/plan-seguridad', payload);
            case 5:
              response = _context.sent;
              if (response.data && response.data.plan) {
                if (!_this4.paciente.planes_seguridad) {
                  _this4.paciente.planes_seguridad = [];
                }
                _this4.paciente.planes_seguridad.unshift(response.data.plan);
            ...
            case 13:
              _context.prev = 13;
              _this4.savingPlanSeguridad = false;
              return _context.finish(13);
            case 16:
            case "end":
              return _context.stop();
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.prev = 1;
              _context2.next = 4;
              return _this5.axios.get("/api/patient/".concat(_this5.pacienteId, "/full-details"));
            case 4:
              res = _context2.sent;
              _this5.paciente = res.data;
              _this5.buildTimeline();
              _context2.next = 12;
              break;
            case 9:
              _context2.prev = 9;
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              _context3.prev = 0;
              _context3.next = 3;
              return _this6.axios.post("/api/pacientes/".concat(paciente.id, "/generar-link"));
            case 3:
              response = _context3.sent;
              _this6.linkGenerado = response.data.link;
      ...
      if (this.paciente.appointments) {
        this.paciente.appointments.forEach(function (a) {
          activities.push({
            ...
            desc: "Cita / Estado: ".concat(_this7.getStatusName(a.status)),
      ...
      try {
        ...
        if (Array.isArray(parsed) && this.ciesData && this.ciesData.length > 0) {
          var names = parsed.map(function (code) {
            var found = _this8.ciesData.find(function (c) {
              return c.id == code;
            });
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              _this9.savingFicha = true;
              _context4.prev = 1;
              payload = {
                patient_id: _this9.paciente.id,
                professional_id: _this9.nuevaFicha.professional_id,
                tipo: _this9.nuevaFicha.tipo,
                frecuencia: _this9.nuevaFicha.frecuencia,
                motivo: _this9.nuevaFicha.motivo,
                recomendaciones: JSON.stringify(_this9.nuevaFicha.recomendaciones),
                interconsultas: _this9.nuevaFicha.interconsultas
              };
              _context4.next = 5;
              return _this9.axios.post('/api/ficha-seguimiento', payload);
            case 5:
              res = _context4.sent;
              _this9.$swal('Éxito', 'Ficha de seguimiento guardada correctamente.', 'success');
              _this9.fichaView = 'historica';
              _this9.nuevaFicha = {
                tipo: '',
                frecuencia: '',
                motivo: '',
              ...
              _this9.fetchPatientDetails(); // Refresh patient data to load new ficha.
              _context4.next = 17;
              break;
            case 12:
              _context4.prev = 12;
              ...
              _this9.$swal('Error', 'Ocurrió un error al guardar la ficha.', 'error');
            case 17:
              _context4.prev = 17;
              _this9.savingFicha = false;
  ...
  mounted: function mounted() {
    ...
    this.axios.get('/api/cies/a').then(function (res) {
      _this11.ciesData = res.data;
    });
    this.axios.get('/api/professional').then(function (res) {
      _this11.professionalsList = res.data;
    })["catch"](function (err) {

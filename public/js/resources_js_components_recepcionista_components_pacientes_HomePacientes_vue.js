...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _this3.savingPlanSeguridad = true;
              payload = _objectSpread({
                patient_id: _this3.paciente.id
              }, _this3.nuevoPlanSeguridad);
              _context.next = 5;
              return axios.post('/api/plan-seguridad', payload);
            case 5:
              response = _context.sent;
              if (response.data && response.data.plan) {
                if (!_this3.paciente.planes_seguridad) {
                  _this3.paciente.planes_seguridad = [];
                }
                _this3.paciente.planes_seguridad.unshift(response.data.plan);
            ...
            case 13:
              _context.prev = 13;
              _this3.savingPlanSeguridad = false;
              return _context.finish(13);
            case 16:
            case "end":
              return _context.stop();
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.prev = 1;
              _context2.next = 4;
              return _this4.axios.get("/api/patient/".concat(_this4.pacienteId, "/full-details"));
            case 4:
              res = _context2.sent;
              _this4.paciente = res.data;
              _this4.buildTimeline();
              _context2.next = 12;
              break;
            case 9:
              _context2.prev = 9;
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              _context3.prev = 0;
              _context3.next = 3;
              return _this5.axios.post("/api/pacientes/".concat(paciente.id, "/generar-link"));
            case 3:
              response = _context3.sent;
              _this5.linkGenerado = response.data.link;
      ...
      if (this.paciente.appointments) {
        this.paciente.appointments.forEach(function (a) {
          activities.push({
            ...
            desc: "Cita / Estado: ".concat(_this6.getStatusName(a.status)),
      ...
      try {
        ...
        if (Array.isArray(parsed) && this.ciesData && this.ciesData.length > 0) {
          var names = parsed.map(function (code) {
            var found = _this7.ciesData.find(function (c) {
              return c.id == code;
            });
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              _this8.savingFicha = true;
              _context4.prev = 1;
              payload = {
                patient_id: _this8.paciente.id,
                professional_id: _this8.nuevaFicha.professional_id,
                tipo: _this8.nuevaFicha.tipo,
                frecuencia: _this8.nuevaFicha.frecuencia,
                motivo: _this8.nuevaFicha.motivo,
                recomendaciones: JSON.stringify(_this8.nuevaFicha.recomendaciones),
                interconsultas: _this8.nuevaFicha.interconsultas
              };
              _context4.next = 5;
              return _this8.axios.post('/api/ficha-seguimiento', payload);
            case 5:
              res = _context4.sent;
              _this8.$swal('Éxito', 'Ficha de seguimiento guardada correctamente.', 'success');
              _this8.fichaView = 'historica';
              _this8.nuevaFicha = {
                tipo: '',
                frecuencia: '',
                motivo: '',
              ...
              _this8.fetchPatientDetails(); // Refresh patient data to load new ficha.
              _context4.next = 17;
              break;
            case 12:
              _context4.prev = 12;
              ...
              _this8.$swal('Error', 'Ocurrió un error al guardar la ficha.', 'error');
            case 17:
              _context4.prev = 17;
              _this8.savingFicha = false;
              return _context4.finish(17);
            case 20:
            case "end":
              return _context4.stop();
          }
        }, _callee4, null, [[1, 12, 17, 20]]);
      }))();
    },
      ...
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          case 0:
            ...
            _this9.$swal.fire('Error', 'Seleccione un archivo', 'warning');
            return _context5.abrupt("return");
          case 4:
            _this9.subiendoDocumento = true;
            _context5.prev = 5;
            formData = new FormData();
            formData.append('file', fileInput.files[0]);
            formData.append('idPaciente', _this9.paciente.id);
            formData.append('idProfesional', _this9.$attrs.idUser || -1);
            formData.append('tipo', _this9.nuevoDocumentoTipo);
            _context5.next = 13;
            return _this9.axios.post('/api/subirArchivo', formData);
          case 13:
            response = _context5.sent;
            if (!_this9.paciente.archivos_list) {
              _this9.$set(_this9.paciente, 'archivos_list', []);
            }
            _this9.paciente.archivos_list.unshift(response.data);
            fileInput.value = '';
            _this9.nuevoDocumentoTipo = '';
          ...
          case 22:
            ...
            _this9.$swal.fire('Error', 'No se pudo subir el archivo. Puede que exceda el tamaño permitido (10MB) o el formato no sea válido.', 'error');
          case 26:
            _context5.prev = 26;
            _this9.subiendoDocumento = false;
  ...
  mounted: function mounted() {
    ...
    this.axios.get('/api/cies/a').then(function (res) {
      _this10.ciesData = res.data;
    });
    this.axios.get('/api/professional').then(function (res) {
      _this10.professionalsList = res.data;
    })["catch"](function (err) {

  ...
  computed: {
    ...
    documentosFiltrados: function documentosFiltrados() {
      ...
      return this.paciente.archivos_list.filter(function (d) {
        return d.tipo === _this.filtroDocumento;
      });
    }
  },
  methods: {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _this2.savingPlanSeguridad = true;
              payload = _objectSpread({
                patient_id: _this2.paciente.id
              }, _this2.nuevoPlanSeguridad);
              _context.next = 5;
              return axios.post('/api/plan-seguridad', payload);
            case 5:
              response = _context.sent;
              if (response.data && response.data.plan) {
                if (!_this2.paciente.planes_seguridad) {
                  _this2.paciente.planes_seguridad = [];
                }
                _this2.paciente.planes_seguridad.unshift(response.data.plan);
            ...
            case 13:
              _context.prev = 13;
              _this2.savingPlanSeguridad = false;
              return _context.finish(13);
            case 16:
            case "end":
              return _context.stop();
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.prev = 1;
              _context2.next = 4;
              return _this3.axios.get("/api/patient/".concat(_this3.pacienteId, "/full-details"));
            case 4:
              res = _context2.sent;
              _this3.paciente = res.data;
              _this3.buildTimeline();
              _context2.next = 12;
              break;
            case 9:
              _context2.prev = 9;
      ...
      if (this.paciente.appointments) {
        this.paciente.appointments.forEach(function (a) {
          activities.push({
            ...
            desc: "Cita / Estado: ".concat(_this4.getStatusName(a.status)),
      ...
      try {
        ...
        if (Array.isArray(parsed) && this.ciesData && this.ciesData.length > 0) {
          var names = parsed.map(function (code) {
            var found = _this5.ciesData.find(function (c) {
              return c.id == code;
            });
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              _this6.savingFicha = true;
              _context3.prev = 1;
              payload = {
                patient_id: _this6.paciente.id,
                professional_id: _this6.nuevaFicha.professional_id,
                tipo: _this6.nuevaFicha.tipo,
                frecuencia: _this6.nuevaFicha.frecuencia,
                motivo: _this6.nuevaFicha.motivo,
                recomendaciones: JSON.stringify(_this6.nuevaFicha.recomendaciones),
                interconsultas: _this6.nuevaFicha.interconsultas
              };
              _context3.next = 5;
              return _this6.axios.post('/api/ficha-seguimiento', payload);
            case 5:
              res = _context3.sent;
              _this6.$swal('Éxito', 'Ficha de seguimiento guardada correctamente.', 'success');
              _this6.fichaView = 'historica';
              _this6.nuevaFicha = {
                tipo: '',
                frecuencia: '',
                motivo: '',
              ...
              _this6.fetchPatientDetails(); // Refresh patient data to load new ficha.
              _context3.next = 17;
              break;
            case 12:
              _context3.prev = 12;
              ...
              _this6.$swal('Error', 'Ocurrió un error al guardar la ficha.', 'error');
            case 17:
              _context3.prev = 17;
              _this6.savingFicha = false;
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _this7.$swal.fire('Error', 'Seleccione un archivo', 'warning');
              return _context4.abrupt("return");
            case 4:
              _this7.subiendoDocumento = true;
              _context4.prev = 5;
              formData = new FormData();
              formData.append('file', fileInput.files[0]);
              formData.append('idPaciente', _this7.paciente.id);
              formData.append('idProfesional', _this7.$attrs.idUser || -1);
              formData.append('tipo', _this7.nuevoDocumentoTipo);
              _context4.next = 13;
              return _this7.axios.post('/api/subirArchivo', formData);
            case 13:
              response = _context4.sent;
              if (!_this7.paciente.archivos_list) {
                _this7.$set(_this7.paciente, 'archivos_list', []);
              }
              _this7.paciente.archivos_list.unshift(response.data);
              fileInput.value = '';
              _this7.nuevoDocumentoTipo = '';
            ...
            case 22:
              ...
              _this7.$swal.fire('Error', 'No se pudo subir el archivo. Puede que exceda el tamaño permitido (10MB) o el formato no sea válido.', 'error');
            case 26:
              _context4.prev = 26;
              _this7.subiendoDocumento = false;
              return _context4.finish(26);
            case 29:
            case "end":
              return _context4.stop();
          }
        }, _callee4, null, [[5, 22, 26, 29]]);
      }))();
    }
  },
  mounted: function mounted() {
    ...
    this.axios.get('/api/cies/a').then(function (res) {
      _this8.ciesData = res.data;
    });
    this.axios.get('/api/professional').then(function (res) {
      _this8.professionalsList = res.data;
    })["catch"](function (err) {
...
var render = function render() {
  ...
  return _c("div", {
  ...
  }), _vm._v(" Activo")]) : _vm._e(), _vm._v(" "), _vm._l(_vm.paciente.semaforo_estados.slice(0, 5), function (sem) {
    return _c("span", {
      key: sem.id,
      staticClass: "badge border bg-warning text-white",
      staticStyle: {
        "font-size": "0.6rem",
        "vertical-align": "middle"
      }
    }, [_c("i", {
      staticClass: "fas fa-tag text-white me-1"
    }), _vm._v(" " + _vm._s(_vm.getEstadoNombre(sem.codigo)) + "\n            ")]);
  })], 2), _vm._v(" "), _c("div", {
    ...
    staticClass: "card border-0 shadow-sm h-100 bg-light"
  }, [_c("div", {
    staticClass: "card-body"
  }, [_c("div", {
    staticClass: "row"
    ...
    return _c("span", {
      key: sem.id,
      staticClass: "badge border bg-white text-dark shadow-sm px-3 py-2"
    }, [_c("i", {
      staticClass: "fas fa-tag text-warning me-1"
    }), _vm._v(" " + _vm._s(_vm.getEstadoNombre(sem.codigo)) + "\n                      ")]);
  }), 0) : _c("div", [_c("small", {
    staticClass: "text-muted"
    ...
    return _c("span", {
      key: index,
      staticClass: "badge bg-info bg-opacity-10 border text-white border-info border-opacity-25 px-3 py-2"
    }, [_vm._v("\n                        " + _vm._s(hobbie) + "\n                      ")]);
  }), 0) : _c("div", [_c("small", {
    staticClass: "text-muted"
  }, [_vm._v("No hay hobbies registrados.")])])])])])])])])])]), _vm._v(" "), _c("div", {
    staticClass: "tab-pane fade",
    attrs: {
      id: "citas",
      role: "tabpanel"
    ...
    }, [_vm._v(_vm._s(mem.precio ? mem.precio.descripcion : "Paquete/Membresía"))]), _vm._v(" "), _c("span", {
    ...
    }, [_vm._v(_vm._s(mem.sesiones_usadas || 0) + " / " + _vm._s(mem.sesiones_totales || 6))])]), _vm._v(" "), _c("div", {
    ...
    }, [_vm._v(_vm._s((mem.sesiones_totales || 6) - (mem.sesiones_usadas || 0)) + " sesiones restantes")])])])]);
  ...
  }, [_vm._v("\n            No tiene paquetes o membresías.\n          ")])]) : _vm._e()], 2), _vm._v(" "), _vm._m(21), _vm._v(" "), _c("div", {
  ...
  }, [_vm._m(22), _vm._v(" "), _c("tbody", [_vm._l(_vm.paciente.appointments || [], function (cita) {
    return _c("tr", {
      key: cita.id
    }, [_c("td", {
    ...
    }, [cita.status == 1 || cita.status == "Confirmada" ? _c("span", {
      staticClass: "badge bg-primary bg-opacity-10 rounded-pill fw-normal px-3 py-2",
      staticStyle: {
        "font-size": "0.8rem"
      }
    }, [_c("i", {
      staticClass: "far fa-calendar-check me-1"
    }), _vm._v(" Confirmada\n                    ")]) : cita.status == 2 || cita.status == "Completada" ? _c("span", {
      staticClass: "badge bg-success bg-opacity-10 rounded-pill fw-normal px-3 py-2",
      staticStyle: {
        "font-size": "0.8rem"
      }
    }, [_c("i", {
      ...
      staticClass: "badge bg-secondary bg-opacity-10 rounded-pill fw-normal px-3 py-2",
      staticStyle: {
        "font-size": "0.8rem"
      }
  ...
  }, [_vm._v("No tiene citas en el historial")])]) : _vm._e()], 2)])])])])]), _vm._v(" "), _c("div", {
    staticClass: "tab-pane fade",
    attrs: {
      id: "historial",
      role: "tabpanel"
    ...
    on: {
      click: function click($event) {
        return _vm.$emit("abrirTriaje", _vm.paciente);
      }
    }
  }, [_c("i", {
    ...
    return _c("div", {
      ...
      staticClass: "d-flex align-items-center"
    }, [_vm._m(45, true), _vm._v(" "), _c("div", [_c("h6", {
      staticClass: "font-weight-bold mb-1 text-dark"
  ...
  }, [_vm._v("Otro")])])]), _vm._v(" "), _vm._m(53), _vm._v(" "), _c("div", {
    staticClass: "mb-4 bg-white p-3 border rounded shadow-sm"
  }, [_c("div", {
    staticClass: "mb-3"
  }, [_c("select", {
  ...
  })])]), _vm._v(" "), _vm._m(54), _vm._v(" "), _c("div", {
  ...
  }, [_vm._v("Asignado automáticamente")])]), _vm._v(" "), _vm._m(55), _vm._v(" "), _c("div", {
    staticClass: "mb-4 bg-white p-3 border rounded shadow-sm"
  ...
  }, [_vm._v("Cancelar")]) : _vm._e()], 2), _vm._v(" "), _vm._m(56), _vm._v(" "), _c("div", {
    staticClass: "mb-4 bg-white p-3 border rounded shadow-sm"
  }, [_c("div", {
    staticClass: "mb-3"
  }, [_c("label", {
  ...
  }, [_vm._m(58), _vm._v(" "), _vm.paciente.prescriptions && _vm.paciente.prescriptions.length > 0 ? _c("div", _vm._l(_vm.paciente.prescriptions, function (receta) {
    return _c("div", {
      key: receta.id,
      ...
      staticClass: "d-flex align-items-center"
    }, [_vm._m(59, true), _vm._v(" "), _c("div", [_c("h6", {
      staticClass: "mb-0 font-weight-bold text-dark fs-5"
    }, [_vm._v("Receta Médica")]), _vm._v(" "), _c("div", {
      staticClass: "small text-muted mt-1"
    }, [_vm._v("\n                        " + _vm._s(_vm.formatDate(receta.created_at)) + " · " + _vm._s(receta.professional ? receta.professional.name : "Dr.") + " "), receta.professional && (receta.professional.cmp || receta.professional.rne) ? _c("span", [_vm._v("- CMP " + _vm._s(receta.professional.cmp || "--") + " / RNE " + _vm._s(receta.professional.rne || "--"))]) : _vm._e()])])]), _vm._v(" "), _c("div", {
      staticClass: "d-flex align-items-center gap-2"
    }, [_c("span", {
    ...
    }, [_vm._v("\n                  Diagnóstico: "), _vm.paciente.initial_psychiatric_history && _vm.paciente.initial_psychiatric_history.diagnostic ? _c("span", [_vm._v(_vm._s(_vm.getCieNames(_vm.paciente.initial_psychiatric_history.diagnostic)))]) : _c("span", [_vm._v("Evaluación médica general")])]), _vm._v(" "), receta.kairos && receta.kairos.length > 0 ? _c("div", {
      staticClass: "d-flex flex-column gap-2 mb-3"
    }, _vm._l(receta.kairos, function (med) {
      return _c("div", {
        key: med.id,
      ...
      }, [_vm._v(_vm._s(med.nombre))]), _vm._v(" "), _c("span", {
        staticClass: "badge bg-warning bg-opacity-10 rounded-pill px-2 border border-warning border-opacity-25",
        staticStyle: {
          "font-size": "0.75rem"
        }
      }, [_vm._v(_vm._s(med.concentracion || med.presentacion || "Dosis"))])]), _vm._v(" "), _c("div", {
        staticClass: "small text-muted mb-2"
      }, [_vm._v("\n                      " + _vm._s(med.pivot.amount || "") + " "), med.pivot.indications ? _c("span", [_vm._v("- " + _vm._s(med.pivot.indications))]) : _vm._e()]), _vm._v(" "), med.pivot.way ? _c("div", {
        staticClass: "small text-primary fst-italic",
        staticStyle: {
          color: "#0d6efd"
        }
      }, [_c("i", {
      ...
      staticClass: "p-3 rounded mb-3 text-muted small",
      staticStyle: {
        "background-color": "#fcfcfc",
        border: "1px solid #f0f0f0"
      }
    ...
    }, [_vm._v("\n                  Válida hasta: "), _c("strong", {
      staticClass: "text-dark"
    }, [_vm._v(_vm._s(_vm.formatDate(receta.effective_date)))])])])]);
  }), 0) : _c("div", {
    ...
    staticClass: "text-muted"
  }, [_vm._v("No hay recetas registradas")])])]), _vm._v(" "), _c("div", {
    directives: [{
      name: "show",
      rawName: "v-show",
  ...
  }, [_vm._m(60), _vm._v(" "), _vm.allMedicalExams && _vm.allMedicalExams.length > 0 ? _c("div", [_c("div", {
    staticClass: "table-responsive"
  }, [_c("table", {
    staticClass: "table table-hover align-middle"
  }, [_vm._m(61), _vm._v(" "), _c("tbody", _vm._l(_vm.allMedicalExams, function (examData, idx) {
    return _c("tr", {
      key: idx
    }, [_c("td", [_vm._v(_vm._s(_vm.formatDate(examData.date)))]), _vm._v(" "), _c("td", {
      staticClass: "fw-bold"
    }, [_vm._v(_vm._s(examData.exam.name))]), _vm._v(" "), _c("td", [_c("span", {
      staticClass: "badge bg-light text-dark border"
    }, [_vm._v(_vm._s(examData.exam.type === 1 ? "Laboratorio" : examData.exam.type === 2 ? "Imagenología" : "Otros"))])]), _vm._v(" "), _c("td", {
      staticClass: "text-muted small"
    }, [_vm._v(_vm._s(examData.doctor))]), _vm._v(" "), _c("td", {
      staticClass: "text-end"
    }, [_c("a", {
      staticClass: "btn btn-sm btn-light border text-primary",
      attrs: {
        href: _vm.getExamPdfUrl(examData),
        target: "_blank"
      }
    }, [_c("i", {
      staticClass: "fas fa-print"
    ...
    staticClass: "text-muted"
  }, [_vm._v("No hay órdenes de exámenes registradas")])])])])]), _vm._v(" "), _c("div", {
    staticClass: "tab-pane fade",
    attrs: {
      id: "pruebas",
      role: "tabpanel"
    ...
    staticClass: "row"
  }, [_vm._m(62), _vm._v(" "), _vm._l(_vm.allTests, function (t, index) {
    return _c("div", {
    ...
    })]), _vm._v(" "), _vm._m(65, true)])]);
  }), _vm._v(" "), _vm.allTests.length === 0 ? _c("div", {
    staticClass: "col-12"
  }, [_vm._m(66)]) : _vm._e()], 2)]), _vm._v(" "), _c("div", {
    staticClass: "tab-pane fade",
    attrs: {
      id: "documentos",
      role: "tabpanel"
    ...
    staticClass: "btn btn-sm rounded-pill px-3",
    "class": _vm.filtroDocumento === "referencias" ? "btn-light bg-white border text-dark" : "btn-light border text-muted",
    attrs: {
      type: "button"
    },
    on: {
      click: function click($event) {
        $event.preventDefault();
        _vm.filtroDocumento = "referencias";
      }
    }
  }, [_vm._v("Referencias")]), _vm._v(" "), _c("button", {
    staticClass: "btn btn-sm rounded-pill px-3",
    ...
    staticClass: "btn btn-sm rounded-pill px-3",
    "class": _vm.filtroDocumento === "recetas" ? "btn-light bg-white border text-dark" : "btn-light border text-muted",
    attrs: {
      type: "button"
    },
    on: {
      click: function click($event) {
        $event.preventDefault();
        _vm.filtroDocumento = "recetas";
      }
    }
  }, [_vm._v("Recetas")]), _vm._v(" "), _c("button", {
    staticClass: "btn btn-sm rounded-pill px-3",
    ...
    }, [_vm._v(_vm._s(doc.nombre))]), _vm._v(" "), _c("span", {
      staticClass: "badge rounded-pill",
      "class": _vm.getBadgeClassDocumento(doc.tipo)
    }, [_vm._v(_vm._s(_vm.getTipoDocumentoNombre(doc.tipo)))])])]), _vm._v(" "), _c("div", {
  ...
  }, [_vm._m(69), _vm._v(" "), _c("tbody", [_vm._l(_vm.paciente.deudas_financieras || [], function (deuda) {
    return _c("tr", {
      key: deuda.id
    }, [_c("td", {
  ...
  }, [_vm._v("No presenta deudas")])]) : _vm._e()], 2)])])])]), _vm._v(" "), _vm._m(70)]), _vm._v(" "), _c("div", {
    staticClass: "modal fade",
    attrs: {
  ...
  }, [_vm._m(71), _vm._v(" "), _vm.fichaSeleccionada ? _c("div", {
    ...
    staticClass: "mb-4"
  }, [_vm._m(72), _vm._v(" "), _vm._l(_vm.fichaSeleccionada.interconsultas, function (inter, idx) {
    return _c("div", {
      key: idx,
  ...
  })], 2) : _vm._e(), _vm._v(" "), _vm.getRecomendacionesParsed(_vm.fichaSeleccionada.recomendaciones).length > 0 ? _c("div", [_vm._m(73), _vm._v(" "), _c("div", {
    staticClass: "d-flex flex-wrap gap-2"
  ...
  }), 0)]) : _vm._e()]) : _vm._e(), _vm._v(" "), _vm._m(74)])])]), _vm._v(" "), _c("div", {
    staticClass: "modal fade",
    attrs: {
  ...
  }, [_vm._m(83), _vm._v(" "), _vm.planSeguridadSeleccionado ? _c("div", {
  ...
  }, [_vm._m(92), _vm._v(" "), _c("div", {
    staticClass: "mb-3"
  }, [_vm._m(93), _vm._v(" "), _c("select", {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.nuevoDocumentoTipo,
      expression: "nuevoDocumentoTipo"
    }],
    staticClass: "form-select",
    attrs: {
      required: ""
    ...
    on: {
      change: function change($event) {
        ...
        _vm.nuevoDocumentoTipo = $event.target.multiple ? $$selectedVal : $$selectedVal[0];
      }
    }
  }, [_c("option", {
    attrs: {
  ...
  }, [_vm._v("Seleccione el tipo...")]), _vm._v(" "), _c("option", {
    attrs: {
      value: "orden"
    }
  }, [_vm._v("Orden de Examen")]), _vm._v(" "), _c("option", {
    attrs: {
      value: "resultado"
    }
  }, [_vm._v("Resultado de Laboratorio/Imagen")]), _vm._v(" "), _c("option", {
    attrs: {
      value: "referencias"
    }
  }, [_vm._v("Referencia/Contrarreferencia")]), _vm._v(" "), _c("option", {
    attrs: {
      value: "consentimiento"
    }
  }, [_vm._v("Consentimiento Informado")]), _vm._v(" "), _c("option", {
    attrs: {
      value: "recetas"
    }
  }, [_vm._v("Receta Externa")]), _vm._v(" "), _c("option", {
    attrs: {
      value: "otro"
    }
  }, [_vm._v("Otro Documento")])])]), _vm._v(" "), _c("div", {
    staticClass: "d-flex justify-content-end gap-2 mt-4 pt-3 border-top"
  }, [_c("button", {
    staticClass: "btn btn-light border px-4",
    attrs: {
    ...
    attrs: {
      type: "submit",
      disabled: _vm.subiendoDocumento
    }
  }, [_vm.subiendoDocumento ? _c("span", {
    staticClass: "spinner-border spinner-border-sm me-2",
    attrs: {
      role: "status",
      "aria-hidden": "true"
...
var staticRenderFns = [function () {
  ...
  var _vm = this,
    _c = _vm._self._c;
  return _c("h6", {
    staticClass: "fw-bold mb-3 text-dark"
  }, [_c("i", {
    staticClass: "fas fa-tags text-primary me-2"
  ...
  return _c("h6", {
    ...
    staticClass: "fas fa-heart text-danger me-2"
  }), _vm._v("\n                      Hobbies e Intereses\n                    ")]);
}, function () {
  var _vm = this,
    _c = _vm._self._c;
  return _c("div", {
    ...
    staticClass: "btn btn-outline-secondary btn-sm bg-white text-dark shadow-sm border rounded"
  }, [_c("i", {
    staticClass: "fas fa-plus me-1"
  ...
  }), _vm._v(" Documentos Adjuntos\n          ")]), _vm._v(" "), _c("p", {
    staticClass: "text-muted small mb-0 mt-1"
  }, [_vm._v("Órdenes de examen, resultados y otros documentos")])]), _vm._v(" "), _c("button", {
    staticClass: "btn btn-primary rounded px-3 shadow-sm",
    attrs: {
      "data-bs-toggle": "modal",
      "data-bs-target": "#modalSubirDocumento"
    }
  }, [_c("i", {
    staticClass: "fas fa-upload me-1"
  ...
  return _c("div", {
    ...
    staticClass: "fas fa-upload text-primary me-2"
  }), _vm._v(" Subir Documento\n          ")]), _vm._v(" "), _c("button", {
    staticClass: "btn-close",
    attrs: {
      type: "button",

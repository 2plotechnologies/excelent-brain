...
/* harmony import */ var _recordatorios_ModalNuevoInteresado_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../recordatorios/ModalNuevoInteresado.vue */ "./resources/js/components/recepcionista/components/recordatorios/ModalNuevoInteresado.vue");
/* harmony import */ var _recordatorios_ModalResponderInteresado_vue__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../recordatorios/ModalResponderInteresado.vue */ "./resources/js/components/recepcionista/components/recordatorios/ModalResponderInteresado.vue");
/* harmony import */ var _adicionales_ModalCambiarSeguimiento_vue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../adicionales/ModalCambiarSeguimiento.vue */ "./resources/js/components/recepcionista/components/adicionales/ModalCambiarSeguimiento.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  components: {
    ModalNuevoInteresado: _recordatorios_ModalNuevoInteresado_vue__WEBPACK_IMPORTED_MODULE_1__["default"],
    ModalResponderInteresado: _recordatorios_ModalResponderInteresado_vue__WEBPACK_IMPORTED_MODULE_2__["default"],
    ModalCambiarSeguimiento: _adicionales_ModalCambiarSeguimiento_vue__WEBPACK_IMPORTED_MODULE_3__["default"]
  },
  data: function data() {
    return {
      cargando: true,
      ...
      fechaInteresados: moment__WEBPACK_IMPORTED_MODULE_0___default()().format('YYYY-MM-DD'),
      filtroDoc: -1,
      doctores: [],
      interesados: [],
      anteriores: [],
  ...
  methods: {
    ...
    horaLatam: function horaLatam(fecha) {
      return moment__WEBPACK_IMPORTED_MODULE_0___default()(fecha).format('hh:mm a');
    },
    ...
    cargarInteresados: function cargarInteresados() {
      var _this3 = this;
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return _this3.axios.get("/api/listarInteresados/".concat(_this3.fechaInteresados)).then(function (response) {
                _this3.interesados = response.data.interesados;
                _this3.anteriores = response.data.anteriores;
              });
            case 2:
            case "end":
    ...
    actualizarInteresados: function actualizarInteresados() {
      this.queId = null;
...
var render = function render() {
  ...
  return _c("main", [_vm._m(0), _vm._v(" "), _c("div", {
    ...
    staticClass: "my2"
  }, [_vm._v("No hay registros")])])])])]) : _vm._e(), _vm._v(" "), _c("ModalNuevoInteresado", {
    attrs: {
  ...
  }), _vm._v(" "), _c("ModalResponderInteresado", {
    attrs: {
    ...
    on: {
      cambiar: function cambiar($event) {
        return _vm.actualizarInteresados();
      }
    }
  })], 1);
};
